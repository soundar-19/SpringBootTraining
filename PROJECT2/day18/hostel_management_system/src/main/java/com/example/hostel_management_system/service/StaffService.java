...
public class StaffService {
    ...
    public java.util.Map<String, Object> getAdminDashboard() {
        java.util.Map<String, Object> dashboard = new java.util.HashMap<>();
        dashboard.put("totalStaff", staffRepository.count());
        dashboard.put("totalStudents", studentRepository.count());
        dashboard.put("wardenCount", staffRepository.findByRole(Staff.StaffRole.WARDEN).size());
        dashboard.put("assistantWardenCount", staffRepository.findByRole(Staff.StaffRole.ASSISTANT_WARDEN).size());
        return dashboard;
    }
}