...
|---------|-------------|--------|
| 📝 **Create Bugs** | Auto-timestamped bug creation with validation | ✅ |
...
| 🗑️ **Cleanup** | Safe bug deletion with validation | ✅ |
| 📦 **DTO Support** | Complete Request/Response DTOs | ✅ |
...
| 🔗 **Bug Assignment** | Assign bugs to Developer role users only | ✅ |
| 🔄 **Profile Updates** | Dynamic user information updates | ✅ |
| 📦 **DTO Support** | Complete Request/Response DTOs | ✅ |
| 🛡️ **Email Validation** | Jakarta Email validation | ✅ |
| 📝 **Field Validation** | Name, email, and role validation | ✅ |
...
<details>
<summary>🔗 <strong>Assigning Bug to Developer</strong></summary>

```bash
# Assign bug ID 5 to user ID 1 (only if user has Developer role)
curl -X PUT http://localhost:8080/api/users/1/assign-bug/5
```

</details>

<details>
<summary>🔄 <strong>Updating User Information</strong></summary>
